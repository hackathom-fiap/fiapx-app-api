...
class RabbitMqAdapterImplementationTest {
    ...
    @Test
    void sendToProcessQueue_withMixedNullAndEmptyFields() {
        Video videoWithMixedFields = Video.builder()
                .id(videoId)
                .title("Test Video")
                .originalFileName("test.mp4")
                .storagePath(null)
        ...
        rabbitMqAdapter.sendToProcessQueue(videoWithMixedFields);
    ...
    @Test
    void sendToProcessQueue_withRabbitTemplateException() {
    ...
    @Test
    void sendToProcessQueue_verifyMessageContentOrder() {
        ArgumentCaptor<Map<String, String>> messageCaptor = ArgumentCaptor.forClass(Map.class);
    ...
    @Test
    void sendToProcessQueue_withVideoIdOnly() {
        Video minimalVideo = Video.builder()
                .id(videoId)
                .build();
        
        ArgumentCaptor<Map<String, String>> messageCaptor = ArgumentCaptor.forClass(Map.class);
        
        rabbitMqAdapter.sendToProcessQueue(minimalVideo);
